...
public class Driver {
    ...
    //Paralel test icin asagidaki threadLocal class'ini ekliyoruz
    //bu havuz bizim icin ihtiyacimiz kadar browser aciyor.
    //böylece driver class'i bize her bir browsewr icin ayri web driver olusturuyor.

    //maven-surefire-plugin --> maven'in beyni:
